#! /home/atri/anaconda3/envs/camb_gw_cosmo/bin/python
import sys
sys.path = ["/home/atri/Downloads/COM_Likelihood_Code-v3.0_R3.10/code/plc_3.0/plc-3.1/lib/python3.1/site-packages"]+sys.path
