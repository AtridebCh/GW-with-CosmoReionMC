    ...
    integer, parameter :: array_len=251
    type TransferParams
    ...
    type, extends (TCAMBParameters) :: CAMBparams
        ...
        real(dl)  :: redshift_array_external(array_len)
        real(dl)  :: reionization_history(array_len)
        logical   :: ReionExternal = .true.
        ...
        !real(dl), allocatable :: reionization_history(:)
        !real(dl), allocatable :: redshift_array_external(:)
