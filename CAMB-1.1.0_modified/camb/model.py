...
class CAMBparams(F2003Class):
    ...
    _fields_ = [
        ...
        ("length_array",c_int,"length of the array"),
        ("redshift_array_external",c_double*array_len,{"size":"length_array"},
        "external redshift array"),
        ("reionization_history",c_double*array_len,{"size":"length_array"},
        "external reion array"),
        ("ReionExternal",c_bool,"whether external reionization"),		
        ...
        #("reionization_history", AllocatableArrayDouble, "store reionization history from user input"),
        #("redshift_array_external", AllocatableArrayDouble, "store the redshift at which reionization history has been given by the user"),
