...
params = Params(("hubble",                [6.711000e+01, 65, 80, 0.01*(80-65.0)]),
                ("ombh2",                 [2.260000e-02, 0.01, 0.03, 0.01*(0.03-0.01)]),
                ("omch2",                 [1.179535e-01, 0.09, 0.2, 0.01*(0.2-0.09)]),
                ("As",                    [2.120000e-09, 1.8e-9, 2.35e-9, 0.01*(2.35e-09-1.8e-09)]),
                ("ns",                    [9.600000e-01, 0.8, 1.2, 0.01*(1.2-0.8)]),
                ("esc_popII",             [0.0036, 0.0, 1.0, 0.01*(0.001)]),
                ("esc_popIII",            [0.00001, 0.0, 1.0, 0.01*(0.001)]),
                ("lambda0",               [2.44, 1.0,10.0,0.01*(6.0-1.0)]),
                ('f_X',                   [0.2, 0.01, 1.0, 0.001]),
                ('f_alpha',               [1.0, 0.01, 1.0, 0.001]))
...
param_latex_name_arr=['H_{0}','\omega_{b} h^{2}', '\omega_{c} h^{2}', 'A_s', 'n_s', 'f_{esc,II}', 'f_{esc,III}', '\lambda_0', 'f_{X}', 'f_{\\alpha}']
