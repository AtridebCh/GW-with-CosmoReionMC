...
params = Params(("hubble",                [6.821184e+01, 65, 80, 0.01*(80-65.0)]),
                ("ombh2",                 [2.31e-02, 0.01, 0.03, 0.01*(0.03-0.01)]),
                ("omch2",                 [1.141812e-01, 0.09, 0.2, 0.01*(0.2-0.09)]),
                ("As",                    [2.06e-09, 1.8e-9, 2.35e-9, 0.01*(2.35e-09-1.8e-09)]),
                ("ns",                    [9.745819e-01, 0.8, 1.2, 0.01*(1.2-0.8)]),
                ("omega_zero",            [-0.96, -1.0, 2.0, 0.1]),
...
param_latex_name_arr=['H_{0}','\omega_{b} h^{2}', '\omega_{c} h^{2}', 'A_s', 'n_s', '\omega_{0}', '\omega_a', 'f_{0}', '\\alpha_{lo}', '\\alpha_{hi}', '\\alpha_{z}', 'f_{esc, II}', '\lambda_0', 'f_{X}', 'f_{\\alpha}']
